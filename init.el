...
values."
  (if (string= (system-name) "mingjiao")
      (defvar plantumldir "/home/maxsense/bin/plantuml.jar")
...
same directory as the org-buffer and insert a link to this file."
  ...
  (defun make-single-frame ()
    ...
    (interactive)
    (if (string= (system-name) "mingjiao")
      (dired-other-frame "/media/maxsense/6605124a-f3c6-4ee5-97f8-0f616f6890f0/tong/SparkleShare/mynotes")
    (dired-other-frame "~/SparkleShare/mynotes"))
  ...
  ;;                (file+headline "~/SparkleShare/mynotes/english/words.org" "Words")
  ;;                "* %U - %:annotation %^g\n\n  %?" :empty-lines 1 :kill-buffer t))

  (setq org-capture-templates
        '(("p" "Link" entry (file+headline ~/SparkleShare/mynotes/english/words.org "Worlds")
